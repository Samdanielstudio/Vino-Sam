...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <div className="fixed bottom-0 left-0 w-[300px] sm:w-[450px] h-[300px] sm:h-[450px] bg-[#D4E4D4]/80 rounded-full filter blur-[70px] sm:blur-[90px] pointer-events-none z-0"       {/* Top Fixed Bar: Minimal Progress & Audio Control */}
